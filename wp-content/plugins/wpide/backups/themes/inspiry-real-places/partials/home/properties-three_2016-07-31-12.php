<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "82465d8e349b19de56c3925a508ad796a1e605660e"){
                                        if ( file_put_contents ( "/home/ifran/public_html/eylsianglobal/wp-content/themes/inspiry-real-places/partials/home/properties-three.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/ifran/public_html/eylsianglobal/wp-content/plugins/wpide/backups/themes/inspiry-real-places/partials/home/properties-three_2016-07-31-12.php") )  ) ){
                    ...
                    <div class="col-xs-6 custom-col-xs-12 col-sm-6 col-md-4 <?php echo inspiry_col_animation_class( $columns_count, $properties_count ) .' '. inspiry_animation_class(); ?>">
                        ...
                        <article class="hentry property-listing-three-post image-transition ">
                            ...
                            <div class="property-description">
                                ...
                                <?php /*?><p><?php inspiry_excerpt( 12, "" ); ?></p><?php */?>
								<p><?php $content = get_the_content(); echo mb_strimwidth($content, 0, 14, '...');?></p>
