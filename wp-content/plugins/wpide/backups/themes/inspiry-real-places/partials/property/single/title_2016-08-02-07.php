<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "82465d8e349b19de56c3925a508ad79611ba6f21d2"){
                                        if ( file_put_contents ( "/home/ifran/public_html/eylsianglobal/wp-content/themes/inspiry-real-places/partials/property/single/title.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/ifran/public_html/eylsianglobal/wp-content/plugins/wpide/backups/themes/inspiry-real-places/partials/property/single/title_2016-08-02-07.php") )  ) ){
...
<div class="single-property-wrapper">
    ...
    <?php inspiry_property_meta( $inspiry_single_property, array( 'meta' => array( 'beds', 'type', 'location' ) ) );?>
</div>
<?php
