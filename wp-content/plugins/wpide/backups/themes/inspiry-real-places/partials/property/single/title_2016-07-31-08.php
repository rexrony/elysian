<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "82465d8e349b19de56c3925a508ad796cacded8ab6"){
                                        if ( file_put_contents ( "/home/ifran/public_html/eylsianglobal/wp-content/themes/inspiry-real-places/partials/property/single/title.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/ifran/public_html/eylsianglobal/wp-content/plugins/wpide/backups/themes/inspiry-real-places/partials/property/single/title_2016-07-31-08.php") )  ) ){
...
<div class="single-property-wrapper">
    <header class="entry-header single-property-header">
        ...
        <h3 class="entry-title single-property-title"><?php the_excerpt(); ?></h3>
