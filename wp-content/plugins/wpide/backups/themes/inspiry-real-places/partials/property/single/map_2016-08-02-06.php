<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "82465d8e349b19de56c3925a508ad79611ba6f21d2"){
                                        if ( file_put_contents ( "/home/ifran/public_html/eylsianglobal/wp-content/themes/inspiry-real-places/partials/property/single/map.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/ifran/public_html/eylsianglobal/wp-content/plugins/wpide/backups/themes/inspiry-real-places/partials/property/single/map_2016-08-02-06.php") )  ) ){
    ...
    if ( file_exists( $base_icon_path .'single-family-home-map-icon.png' ) ) {
        $property_marker['icon'] = $base_icon_uri . 'single-family-home-map-icon.png';
        if( file_exists( $base_icon_path . '-map-icon@2x.png' ) ) {
            $property_marker['retinaIcon'] = $base_icon_uri . '-map-icon@2x.png';   // retina icon
        }
    } else {
        $property_marker['icon'] = $base_icon_uri . 'single-family-home-map-icon.png';           // default icon
