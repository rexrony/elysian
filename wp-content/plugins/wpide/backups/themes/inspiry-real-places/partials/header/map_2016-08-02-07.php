<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "82465d8e349b19de56c3925a508ad79611ba6f21d2"){
                                        if ( file_put_contents ( "/home/ifran/public_html/eylsianglobal/wp-content/themes/inspiry-real-places/partials/header/map.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/ifran/public_html/eylsianglobal/wp-content/plugins/wpide/backups/themes/inspiry-real-places/partials/header/map_2016-08-02-07.php") )  ) ){
...
if ( $map_query->have_posts() ) :
    ...
    while ( $map_query->have_posts() ) :
        ...
        if( file_exists( get_template_directory() . '/images/map/' . 'single-family-home-map-icon.png' ) ) {

            $current_prop_array['icon'] = get_template_directory_uri() . '/images/map/' . 'single-family-home-map-icon.png';

            // retina icon

            if( file_exists( get_template_directory() . '/images/map/' . 'single-family-home-map-icon@2x.png' ) ) {
