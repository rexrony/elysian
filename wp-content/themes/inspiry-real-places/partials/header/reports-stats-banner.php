...
if ( !$skip_banner ) {
    ...
    ?>
    <div class="page-head-reports <?php echo esc_attr( $banner_variation_class ); ?>" style="<?php inspiry_generate_background( $inspiry_banner_bg_color, $inspiry_banner_bg_image ); ?>">
      
            <div class="container">
            <div class="report-captions col-md-12">
                <h2>At a glance look in the world<br> of UK Real Estate Industry</h2>
            </div>
            </div>
    </div><!-- .page-head -->
    <?php
