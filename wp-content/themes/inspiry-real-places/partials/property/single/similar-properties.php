                ...
                while ( $similar_properties_query->have_posts() ) :
                    ...
                    <article class="hentry clearfix">
                        ...
                        <div class="property-description">
                            ...
                            <?php /*?><?php inspiry_property_meta( $similar_property, array( 'meta' => array( 'area', 'beds', 'baths', 'garages', 'type' ) ) ); ?><?php */?>
                            <?php inspiry_property_meta( $similar_property, array( 'meta' => array( 'area', 'beds', 'type' ) ) ); ?>
                        </div>
