            ...
            <li>
                <div class="slide-overlay container">
                    <div class="slide-inner-container">
                        ...
                        <div class="meta-item-half hidden-md hidden-xs hidden-sm">
                           <?php /*?> <?php inspiry_property_meta( $slider_property, apply_filters( 'inspiry_slider_two_meta', array( 'meta' => array( 'area', 'beds', 'baths', 'garages', 'type' ) ) ) ); ?><?php */?>
                            <?php inspiry_property_meta( $slider_property, apply_filters( 'inspiry_slider_two_meta', array( 'meta' => array( 'area', 'beds', 'type' ) ) ) ); ?>
                        </div>
                        ...
                        if ( !empty( $inspiry_options[ 'inspiry_slide_button_text' ] ) ) {
                            ?><a class="btn-default btn-orange" href="<?php the_permalink(); ?>"><?php echo esc_html( $inspiry_options[ 'inspiry_slide_button_text' ] ); ?><!--<i class="fa fa-angle-right"></i>--></a><?php
                        }
                        ?>
