...
// TO LIMIT the Post Content (add the following code in function.php)
...
function search_property_meta( $inspiry_property, $property_meta_array = array()  ) {
                    ...
                    case 'beds':
                        ...
                        if ( $inspiry_property_beds ) {
                          ...
                          <!---   <div class="meta-item">
                                ...
                                <div class="meta-inner-wrapper">
                                    <span class="meta-item-label"><?php //echo esc_html( $inspiry_property_beds ); ?>&nbsp; <?php //_e( 'Bedrooms', 'inspiry' ); ?></span>
                                    <span class="meta-item-value"></span>
                                </div>
                            </div>--->
<li><div class="propertymeta-beds propertymeta col-md-12"> 
                          <i class="meta-item-icon icon-bed iconbed"><?php include( $temp_dir . '/images/svg/icon-bed.svg' ); ?></i>
                           <span><?php echo esc_html( $inspiry_property_beds ); ?>&nbsp; <?php _e( 'Bedrooms', 'inspiry' ); ?></span>
                           </div>
                           </li>
                            <?php
                        }
            ...
            <li> <div class="propertymeta-type propertymeta col-md-12"> <i class="meta-item-icon icon-ptype iconptype"><?php include( $temp_dir . '/images/svg/icon-ptype.svg'); ?></i>
                           <span><?php echo esc_html( $inspiry_property_types ); ?></span>
                           </div><!-- .Property meta type --->
                           </li>
                            <?php
                        }
                        break;
...
function modify_footer_admin () {
 echo '<style type="text/css">
  ...
  echo '<a href="http://brandstallion.com/" target="_blank" title="Brandstallion">Brandstallion</a> runs on the worlds most renowned content management system';
}
...
function custom_logo() {
  echo '<style type="text/css">
	...
	//#wphead h1 a,#user_info a:link, #user_info a:visited, #footer a:link, #footer 

a:visited,#user_info{ color:#fff}
    #main-bar{  background: url("'.get_bloginfo('template_directory').'/images/admin/logo-bg.jpg") 

repeat-x; left: 0; position: absolute; top: 0; width: 100%; z-index: 1; height:91px;}
  ...
  <script>
	jQuery(document).ready(function(){
		jQuery('body').append('<div id="main-bar"><a title="Brandstallion" target="_blank" href="http://brandstallion.com/"><img border="0" src="<?php bloginfo('template_directory'); ?>/images/admin/cr-logo.jpg"></a></div>');
	});
  </script>    
<?php 	
}
...
function custom_login_logo() {
  echo '<style type="text/css">
    h1 a { background-image:url('.get_bloginfo('template_directory').'/images/admin/logo-login.jpg) !important; background-size:auto !important; width:180px !important; height:80px !important; }
#main-bar{ 
display:none !important; 
background: url("'.get_bloginfo('template_directory').'/images/admin/logo-bg.jpg") repeat-x; left: 0; position: absolute; top: 0; width: 100%; z-index: 1; height:91px;}
	#backtoblog{top:92px}
	#login{}	
    </style>';
	?>
  ...
  <script>
	jQuery(document).ready(function(){
	/*	jQuery('body').append('<div id="main-bar"><a title="Craftive" target="_blank" href="http://www.craftive.com/"><img border="0" src="<?php bloginfo('template_directory'); ?>/images/admin/cr-logo.jpg"></a></div>');*/	
$('#login h1 a').attr('href', 'http://brandstallion.com/')
});
  </script>    
  <?php 
}
