...
<footer class="site-footer site-footer-<?php echo esc_attr( $footer_variation ); ?>">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12 footer-widget-area fade-in-up <?php echo inspiry_animation_class(); ?>">
            ...
            <div class="col-lg-12 footer-logo fade-in-left <?php echo inspiry_animation_class(); ?>">
